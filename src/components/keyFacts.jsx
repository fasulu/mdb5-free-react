...
export default function KeyFacts() {
    ...
    const textStyle = { fontSize: 'clamp(17px, 2.5vw, 20px)' };
                ...
                <MDBCardBody>
                    ...
                    <div>
                        ...
                        <div style={{ borderRadius: '5px', backgroundColor: '#d1ecf1', padding: "15px" }}>
                            <p style={{ fontSize: 'clamp(16px, 2.5vw, 18px)', textStyle: 'bolder' }}><strong>LARGER ACCOMMODATION IS VERY SCARCE</strong></p>
                        ...
                        <ul className='mt-3'>
                            <li style={{fontSize: 'clamp(16px, 2.5vw, 18px)'}}>Between 1 January and 31 December 2022, the council let 0 properties that had 6 bedrooms or larger but have 117 households on the housing register for this sized property.</li>
                        </ul>

                        <div style={{ borderRadius: '5px', backgroundColor: '#d1ecf1', padding: "15px" }}>
                            <p style={{ fontSize: 'clamp(16px, 2.5vw, 18px)', textStyle: 'bolder' }}><strong>BE REALISTIC ABOUT YOUR CHANCES OF SECURING A COUNCIL PROPERTY</strong></p>
